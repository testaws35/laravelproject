            ...
            $exception = DB::transaction(function() use ($request) {
              ...
              if(is_null($exception)) {
                    ...
                    return redirect()->route('elders.index')
                              ->with('success',Lang::get('home.faq_create_success'));
                    ...
                    // Here we are calling back the index method of Controller so that it fetches data and returns view with content
                    return redirect()->route('elders.index')
                     ->with('message',Lang::get('home.faq_create_error'));
            ...
            // Transaction
             $exception = DB::transaction(function() {
               ...
               if(is_null($exception)) {
                     DB::commit();
                     return back() 
                        ->with('Success',Lang::get('home.elder_reg_success'));
                     ...
                     return back()
                     ->with('message',Lang::get('home.elder_reg_error'));
