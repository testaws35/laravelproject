...
class HelpPostController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (isset($helpposts)){
            ...
            return view('helpposts.index',compact('helpposts','currentMonthName','currentYear'))
            ->with('Failed',Lang::get('home.help_post_unavailable'));
               ...
               [
                ...
                if(is_null($exception)) {
                    ...
                    return redirect()->route('helpposts.index')
                                    ->with('success',Lang::get('home.help_post_success'));
                    ...
                    // Here we are calling back the index method of Controller so that it fetches data and returns view with content
                    return redirect()->route('helpposts.index')
                                     ->with('message',Lang::get('home.help_post_error'));
    ...
    public function show($HelpID)
    {
        ...
        if (isset ($HelpID)  ) {
            ...
            else
            {
                ...
                $comments = null;
                return view('helpposts.show', compact('helppost','comments','helpposts'))
                        ->with('Failed',Lang::get('home.faq_error_missingid') );
                    ...
                    $comments = null;
                    return view('helpposts.show', compact('helppost','comments','helpposts'))
                    ->with('Failed',Lang::get('home.faq_error_empty') );
    ...
    public function edit($HelpID) {
        ...
        if (isset($HelpID))
        {
            ...
            If (isset($helppost)){
                ...
                return view('helpposts.edit', compact('helppost'))
                            ->with('Failed',Lang::get('home.help_post_missing') );
            ...
            return view('helpposts.edit', compact('helppost') )
                ->with('Failed',Lang::get('home.postid_error') );
    ...
    public function update(Request $request)
    {
         ...
         try {
            ...
            if(is_null($exception)) {
                ...
                // Here we are calling back the index method of Controller so that it fetches data and returns view with content
                return redirect()->route('helpposts.index')
                ->with('success',Lang::get('home.help_post_updatesuccess') );
                ...
                // Here we are calling back the index method of Controller so that it fetches data and returns view with content
                return redirect()->route('helpposts.index')
                ->with('Failed',Lang::get('home.help_post_error') );
    ...
    public function destroy(Request $request)
    {
       ...
       // Transaction
        $exception = DB::transaction(function() use ($request) 
        {
                ...
                return redirect('/helpposts')->with('success',Lang::get('home.help_post_deletesuccess') );
            }); //end of transaction
            ...
            if(is_null($exception)) {
                ...
                // Here we are calling back the index method of Controller so that it fetches data and returns view with content
                return redirect()->route('helpposts.index')
                      ->with('success', Lang::get('home.help_post_deletesuccess'));
               ...
               // throw new Exception;
                ...
                // Here we are calling back the index method of Controller so that it fetches data and returns view with content
                return redirect()->route('helpposts.index')
                    ->with('Failed', Lang::get('home.help_post_deleteerror'));
