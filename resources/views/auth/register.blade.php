...
<section class="testimonial py-5" id="testimonial" >
          ...
          @endif-->
          @if (session('success'))
                    <div class="alert  alert-success alert-dismissible fade col-lg-3 pull-right  show" role="alert" id="alertad">
                        {{ session('success') }}
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
            ...
            <div class="col-md-4 py-5 bg-primary text-white text-center ">
                <div class=" ">
                    <div class="card-body">
                        ...
                        <p style="font-size:18px;color:#fff;font-family: 'Sen', sans-serif;"><b style="font-weight:600;">@lang('home.note'):</b> @lang('home.reg_note_msg')  </p>
                   </div>
                </div>
            </div>
                  ...
                  {{ csrf_field() }}
                    <!--START 1st form-row  -->
                     <div class="form-row">
                            <!--START form-group col-md-6  -->
                              <div class="form-group col-md-6 {{ $errors->has('User_Phone') ? 'has-error' : '' }}">
                                <label> <b style="font-family: 'Sen', sans-serif;font-weight:700;">@lang('home.matrimonys_create_basicdetails_mobileno') :</b></label>
                                  <input type="tel" class="keyupcharactervalidation"  id="User_Phone"  name="User_Phone" value="{{ old('User_Phone') }}" required  placeholder="@lang('home.reg_mobileno_placeholder')" oninput="this.className = ''" onfocus="this.placeholder=''"  maxlength="10" minlength="10" >
                              ...
                              <input id="User_InvitationID" type="invitation"  name="User_InvitationID" value="{{ old('User_InvitationID') }}" required  onchange="checkInvite()" placeholder="@lang('home.reg_inviteid_placeholder')"   oninput="this.className = ''" onfocus="this.placeholder=''" onblur="checkInvite()">
                                <p id="User_InvitationIDerror"></p>
                     ...
                     <div class="form-row">
                            ...
                            <!--START form-group col-md-6  -->
                            <div class="form-group col-md-6">
                                <label><b style="font-family: 'Sen', sans-serif;font-weight:700;">@lang('home.matrimonys_create_basicdetails_name') : </b></label>
                                <input id="name" maxlength="15"  type="text"  name="name" value="{{ old('name') }}" required placeholder="@lang('home.reg_personaldetails-name_placeholder')" oninput="this.className = ''" onfocus="this.placeholder=''" onblur="this.placeholder='' ">
                                @if ($errors->has('name'))
                                <span class="invalid-feedback" role="alert">
                            ...
                            <!--START form-group col-md-6  -->
                              <div class="form-group col-md-6">
                                <label><b style="font-family: 'Sen', sans-serif;font-weight:700;">@lang('home.myprofile_show_subheading_uname') : </b></label>
                                <input id="username" type="text" maxlength="15"   name="username" value="{{ old('username') }}" required placeholder="@lang('home.reg_logindetails-uname_placeholder')" onchange="checkUniqueUser()"  oninput="this.className = ''" onfocus="this.placeholder=''" onblur="this.placeholder='' ">
                     ...
                     <div class="form-row">
                            <!--START form-group col-md-6  -->
                              <div class="form-group col-md-6">
                                  <label><b style="font-family: 'Sen', sans-serif;font-weight:700;">@lang('home.login_password') : </b></label>
                                  
                                  <input id="password" type="password" class="@error('password') is-invalid @enderror" name="password" required   autocomplete="new-password" onchange="validatepassword()" placeholder="@lang('home.login_password')" oninput="this.className = ''" onfocus="this.placeholder=''" maxlength="10" >
                                  <input class="register_checkboxmob" type="checkbox" onclick="showpwd()" title="Show Password">
                              ...
                              <div class="form-group col-md-6">
                                    ...
                                    <input id="password-confirm" type="password"  name="password_confirmation" required   onchange="validatepassword()"  autocomplete="new-password"placeholder="@lang('home.reg_logindetails-cpwd')" oninput="this.className = ''" onfocus="this.placeholder=''" onblur="this.placeholder=''"  maxlength="10">
                                    <input type="checkbox" onclick="showpwd1()" class="register_checkboxmob">
                     ...
                     <div class="form-row">
                            <!--START form-group col-md-6  -->
                            <div class="form-group col-md-6">
                                  <label><b style="font-family: 'Sen', sans-serif;font-weight:700;">@lang('home.matrimonys_create_basicdetails_caste') :</b></label>
                                  <select id="caste" name="User_Caste"  required onchange="castemaster()">
                                     <option>@lang('home.matrimonys_index_welcome_select_option')</option>
                           ...
                           <!--END form-group col-md-6  -->
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <label ><b style="font-family: 'Sen', sans-serif;font-weight:700;white-space: nowrap;">@lang('home.reg_personaldetails-subcaste')  :</b></label>
                    ...
                    <!--END 4th form-row  -->
                     ...
                     <div class="form-row">
                            ...
                            <div class="form-group col-md-1">
                                  <input type="checkbox" class="register_checkboxmob" name="colorCheckbox"> 
                   ...
                   <div class="form-row">
                        <button type="submit" class="btn" onclick="success()" style="background: #f82249;font-family: 'Sen', sans-serif;color:#fff;border-bottom-right-radius:25px;border-top-left-radius:25px;">@lang('home.matrimonys_create_finalsubmitbtn')</button>
                    </div>
               </form>
            </div>
        </div>
           ...
           success:function(res){
               ...
               if(res){
                              ...
                              if (  res.msg === "Invitation and Phone number matches.  Please proceed" )  
                              {
                                    ...
                                    $("#User_InvitationIDerror").html("Your invitation is validated. Kindly proceed!");
                                    $("#User_InvitationIDerror").css("color", "green");
                                    $("#User_InvitationIDerror").fadeOut(3000);                                    
                                    $("#name").focusin();
                                    ...
                                    document.getElementById("subcaste").disabled = false;
                                    return true;
                              }
                              else if ( res.msg === "Invitation is already used. Kindly try with a new Invitation" )  
                              {
                                 ...
                                 // showToastAlert("Error", 'Invitation is already used. Kindly try with a new Invitation', 'error');
                                  $("#User_InvitationIDerror").html("Invitation is already used. Kindly try with a new Invitation");
                                  $("#User_InvitationIDerror").css("color", "red");
                                  $("#User_InvitationIDerror").fadeOut(3000);
                                  ...
                                  document.getElementById("subcaste").disabled = true;
                                  return false;
                              ...
                              else if ( res.msg === "Given Phone number is wrong. It doesnot match with this Invitation ID" )  
                              {
                                    ...
                                    /*JQuery refers to html control by $("#controlname")*/
                                    $("#User_InvitationIDerror").html("Given Phone number is wrong. It doesnot match with this Invitation ID");
                                    $("#User_InvitationIDerror").css("color", "red");
                                    $("#User_InvitationIDerror").fadeOut(3000);
                                    $("#User_InvitationID").val("");
                              ...
                              else if ( res.msg === "Given Phone number and Invitation ID is wrong. It doesnot match with any Invitation" )  
                              {
                                  ...
                                  // showToastAlert("Error", 'Given Phone number and Invitation ID is wrong. It doesnot match with any Invitation', 'error');
                                    /*JQuery refers to html control by $("#controlname")*/
                                    $("#User_InvitationIDerror").html("Given Phone number and Invitation ID is wrong. It doesnot match with any Invitation");
                                    $("#User_InvitationIDerror").css("color", "red");
                                    $("#User_InvitationIDerror").fadeOut(3000);
                                    $("#User_InvitationID").val("");
                                    $("#User_InvitationID").focusin();
 ...
 //  alert ("in unique user");
       ...
       //8. when you use JQuery you will use $("#controlid")
        ...
        $.ajax({
           ...
           dataType: "JSON",
           url:"{{url('checkUniqueUser')}}?Username="+Username,
           success:function(res){    
...
<script>
    function success(){
        if (!$('input[name="colorCheckbox"]').is(':checked'))
		  {
			$('#terms_error').html("please accept the terms and condition");
...
//alert ("in validate password");
      ...
      //  alert(confirmPassword);
        ...
        //   alert("inside oiuter if");
		 ...
		 $('.keyupcharactervalidation').keyup(function(e)
   {
        var regex = /^\d+$/;
